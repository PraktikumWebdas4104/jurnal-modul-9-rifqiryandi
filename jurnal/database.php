...
class database{
	...
	function input($nama,$alamat,$usia){
		$que = mysqli_query($this->conn,"INSERT INTO data(nama, alamat, usia, id) VALUES ('$nama','$alamat','$usia','')");//buatlah method input
		if ($$que) {
			echo "Berhasil";
	...
	function update($id,$nama,$alamat,$usia){
		$que = mysqli_query($this->conn,"UPDATE data SET nama='$nama',alamat='$alamat',usia='$usia' WHERE id='$id'");//buatlah method update
		if ($que) {
			echo "berhasil";# code...
